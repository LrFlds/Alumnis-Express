...
class Constantes {
    ...
    messageActivate = `<p>Bienvenue sur notre site réservé exclusivement aux apprenants et alumnis de Simplon.</p>
                        <p> Un profil a été préalablement créé, il vous suffit de l'activer en cliquant içi, on vous demandera de réinitialiser votre mot de passe</p>
                        <p> à bientôt sur Alumnis</p>
                        <p> L'équipe d'Alumnis</p>`
