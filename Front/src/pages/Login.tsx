...
const handleCancel = () => {
 ...
 <div id="js-cookie-box" className="cookie-box cookie-box--hide">
      En poursuivant votre navigation sur ce site, vous acceptez l'utilisation de cookies 🍪 ! <span id="js-cookie-button" className="cookie-button">Allez pourquoi pas</span>
    </div>
